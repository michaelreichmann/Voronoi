...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 967.666666666666629, 217.4453125, 38.0, 20.0 ],
					"text" : "invert"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 935.0, 215.4453125, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 935.0, 257.890625, 55.0, 22.0 ],
					"text" : "invert $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 389.0, 147.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 820.333333333333371, 257.890625, 82.0, 22.0 ],
					"text" : "numPoints $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 705.666666666666629, 257.890625, 48.0, 22.0 ],
					"text" : "time $1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 342.0, 9.0, 150.0, 20.0 ],
									"text" : "dummy inlets"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 306.0, 9.0, 28.0, 22.0 ],
									"text" : "in 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 271.0, 9.0, 28.0, 22.0 ],
									"text" : "in 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 232.0, 9.0, 28.0, 22.0 ],
									"text" : "in 2"
								}
...
, 							{
								"box" : 								{
									"code" : "//create noise\r\nFNoise(p)\r\n{\r\n\ta = fract(p.xyx * vec(123.45, 234.56, 345.67));\r\n\ta += dot(a, a + 345.67);\r\n\ta -= sin(a) * 1.2345;\r\n\tb = vec(a.x * a.y, a.y * a.z);\r\n\treturn fract(b);\r\n}\r\n\r\nParam time(1);\r\nParam numPoints(10);\r\nParam invert(0);\r\n\r\n//coordinates\r\nuv = mix(-2, 2, norm(in1));\r\nminDist = 5;\r\n\r\n//distance\r\nfor(i = 0; i < numPoints; i+=1)\r\n{\r\n\tn = FNoise(vec(i,i));\r\n\tp = sin(n * time );\r\n\td = length(uv - p);\r\n\t\r\n\tif(d < minDist)\r\n\t{\r\n\t\tminDist = d;\r\n\t}\t\r\n}\r\n\r\nif(invert == 1)\r\n{\r\n\tminDist = 1 - minDist;\r\n}\r\n\r\nout1 = minDist;",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-5",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 45.0, 664.0, 594.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 649.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 591.0, 292.4453125, 363.0, 22.0 ],
					"text" : "jit.gl.pix @title voronoi"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 623.666666666666629, 209.9453125, 80.0, 33.0 ],
					"text" : "signal-driven counter"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 389.0, 86.5, 83.0, 39.0 ],
					"text" : "2. Start Audio"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 13.0, 108.0, 39.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 820.333333333333371, 153.4453125, 50.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_exponent" : 2.0,
							"parameter_initial" : [ 10 ],
							"parameter_initial_enable" : 1,
							"parameter_longname" : "numPoints",
							"parameter_mmax" : 50.0,
							"parameter_shortname" : "numPoints",
							"parameter_type" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 705.666666666666629, 159.4453125, 41.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 275.0, 159.0, 77.0, 22.0 ],
									"text" : "loadmess 38"
								}
...
,
									"patching_rect" : [ 176.5, 159.0, 89.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 26.0, 63.0, 72.0, 22.0 ],
									"text" : "phasor~ 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 112.0, 63.0, 46.0, 22.0 ],
									"text" : "r fbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 26.0, 159.0, 105.0, 22.0 ],
									"text" : "snapshot~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 176.5, 195.0, 61.0, 22.0 ],
									"text" : "counter"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 26.0, 241.0, 169.5, 22.0 ],
									"text" : "+ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 26.0, 333.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 284.5, 187.5, 217.5, 187.5 ],
									"source" : [ "obj-2", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 35.5, 121.5, 186.0, 121.5 ],
									"order" : 0,
									"source" : [ "obj-41", 0 ]
								}
...
,
					"patching_rect" : [ 705.666666666666629, 215.4453125, 59.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 332.0, 81.0, 20.0 ],
					"text" : "monitor video"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 60.0, 136.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 591.0, 386.9453125, 173.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 591.0, 72.9453125, 214.0, 35.0 ],
					"text" : "jit.gl.node @dim 1920 1080 @adapt 0 @name fxnode @capture 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 177.0, 266.0, 150.4453125 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 591.0, 347.4453125, 209.0, 35.0 ],
					"text" : "jit.gl.videoplane @preserve_aspect 1 @smooth_shading 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 147.5, 136.0, 48.0, 22.0 ],
					"text" : "s fbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 59.5, 136.0, 80.0, 35.0 ]
				}
...
,
					"patching_rect" : [ 37.0, 59.0, 28.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.0, 59.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 92.0, 304.0, 35.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 14.5, 130.0, 69.0, 130.0 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
